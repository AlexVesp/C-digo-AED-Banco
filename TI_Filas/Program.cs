...
namespace TI_Filas
{
    class Program
    {
       static string CAMINHO_DO_ARQUIVO = @"C:\Users\rafae\OneDrive\Ambiente de Trabalho\TI_Filas2\TI_Filas\TI_Filas\dados\cliente.txt";  //Caminho do arquivo Usar o @"CAMINHO_DO_ARQUIVO_NO_SEU_PC.txt"
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("[INFO]: Alexander Freire && Rafael Massula");
            Console.WriteLine("=============================[]============================="); 
